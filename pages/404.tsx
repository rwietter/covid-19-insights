  ...
  return (
    <div className='relative w-full h-screen overflow-hidden'>
      <div className="flex flex-col justify-center absolute z-10 w-full h-full items-start p-10 lg:p-72 bg-white">
        ...
        <h2 className="text-2xl text-slate-700 pt-4 font-semibold">OOPS... PÁGINA NÃO ENCONTRADA :(</h2>
        <p className="text-lg pt-2 max-w-xl text-slate-700">Nós sugerimos voltar para a página inicial enquanto tentamos resolver o problema.</p>
        <Link
          href="/"
